<template>
  <div class="listpage" id="film">
    ...
    <div class="toolbar" v-if="!show.find && showToolbar">
      <el-select v-model="selectedAreas" size="small" multiple collapse-tags placeholder="地区" popper-class="popper" :popper-append-to-body="false" @visible-change="refreshFilteredList($event)">
        <el-option
          v-for="item in areas"
          :key="item"
          :label="item"
